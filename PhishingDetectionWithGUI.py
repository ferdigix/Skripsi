...
def PhishingDetection(link):
    ...
    countDoubleSlash = 0 #len(re.findall("(?<!http:)(?<!https:)//", link))
    ...
    #===================================================================================================================================#
    # Old Methode for Domain In subdomain (Compares with the list given in generictld) meaning it doesn't check all of the TLD and ccTLD#
    #===================================================================================================================================#
    # generictld = ['com','org','net','int','edu','gov','mil']

    # resultDomainInSubdomain = 0
    # intersection = set(subdomainList).intersection(generictld)
    # print(list(intersection))
    # print(len(list(intersection)))

    # tempdomaininsubdomain = len(list(intersection))

    # if tempdomaininsubdomain > 0:
    #     resultDomainInSubdomain = 1
    # elif tempdomaininsubdomain == 0:
    #     resultDomainInSubdomain = 0

    # print(resultDomainInSubdomain)
    ...
    try:
        ...
        for objecturl in soup.find_all('object'):
            ...
            # print(counttotalobject)
            # print(countExtObjectDomain)
    ...
    #===================#
            # print(resultexturl)
            counttotalurl += 1
            # tempExtUrl = list(urlsplit(resultexturl))
            tempExtUrl2 = tldextract.extract(resultexturl)

            # print(tempExtUrl)
            # print(tempExtUrl2.domain)
        ...
        #=============================#
                    ...
                    # print(resultdomainonly)
                    # print(resultdomainonly[1])
                    # print(counttotalurlxd)
                    # print(resultSubdomain.domain)
                    # print(resultHostname[1])
                    # print(resultdomainonly.domain)
    ...
    #================================#
            ...
            # if resultexturl = resultexturl.startswith("javascript:void(0)"):
            #     countPctNullSelfRedirectHyperlinks += 1
            # print(resultexturl)
            # print(PctNullSelfRedirectHyperlinks3)

                if PctNullSelfRedirectHyperlinks0 == True:
                    countPctNullSelfRedirectHyperlinks += 1
                elif (PctNullSelfRedirectHyperlinks1 > 0):
                    countPctNullSelfRedirectHyperlinks += 1
                elif (PctNullSelfRedirectHyperlinks2 > 0):
                    countPctNullSelfRedirectHyperlinks += 1
                elif (PctNullSelfRedirectHyperlinks3 == True):
                    countPctNullSelfRedirectHyperlinks += 1

            # print(countPctNullSelfRedirectHyperlinks)
            # print(counttotalurl)

        # print(countPctNullSelfRedirectHyperlinks)
        # print(counttotalurl)
        # print(countFrequentDomainNameMismatch)
        # print(counttotalurlxd)
        # print(resultFrequentDomainNameMismatch)
                #==================================#
    ...
    #====================#
                if resulttest.startswith(tuple(ALPHA)):
                    ...
                    countRelativeURL += 1
                    # print(tempRelativeFormAction)
                    # print(checkRelativeFormAction[1])
                ...
                # AbnormalFormAction = len(re.findall("#", resulttest))
                # print(AbnormalFormAction)
                # print(countRelativeURL)
    ...
    #====================#
                ...
                elif (AbnormalFormAction1 > 0):
                    countAbnormalFormAction += 1
                elif (AbnormalFormAction2 > 0):
                    countAbnormalFormAction += 1
                elif (AbnormalFormAction3 == True):
                    countAbnormalFormAction += 1
                # print(countAbnormalFormAction)
    ...
    #===============#
                ...
                # print(insecureForm)
                # print(AbnormalFormAction)
                # print(AbnormalFormAction1)
                # print(AbnormalFormAction2)
                # print(AbnormalFormAction3)
                # if insecureForm == 0:
                #     print("No InsecureForms found")
                # else:
                #     print("InsecureForm found")
    ...
    #============#
        ...
        if resultFavicon >= 1:
            ...
            finalResultFavicon = 0
        # if resultFavicon >= 1:
        #     print("Website is most likely a Phishing website")
            # print(resultFavicon)
    ...
    imageHtml = len(soup.find_all('img'))
    # print(imageHtml)
    ...
    if imageHtml != 0 and textHtmlC == 0:
        countImageOnly = 1
    else:
        countImageOnly = 0
    ...
    # if result == 1:
    #     return sg.popup("Website is Phishing")
    # elif result == 0:
    #     return sg.popup("Website is Safe")
    # data = pd.DataFrame(atr)
    # filepath = 'Phishing_Dataset.xlsx'
    # path = Path(filepath)

    # if path.is_file() == False:
    #     data.to_excel('Phishing_Dataset.xlsx', sheet_name='sheet1', index=False, header=True)
    # else:
...
window = sg.Window('Web Phishing Detection', layout)
